package com.msj.webservices.springrestapi;
...
public class SwaggerConfig {
    public static final Contact DEFAULT_CONTACT = new Contact("Muljayan", "", "");
    public static final ApiInfo DEFAULT_API_INFO = new ApiInfo(
            "Springboot Rest API",
            "Documentation for rest api implemented with Spring",
            "1.0",
